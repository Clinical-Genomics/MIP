package MIP::Recipes::Download::Manta_call_regions;
...
BEGIN {
    ...
    our @EXPORT_OK = qw{ download_manta_call_regions };

}

sub download_manta_call_regions {

## Function : Download manta call regions file (bgzip and tbix indexed)
## Returns  :
