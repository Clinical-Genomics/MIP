...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Gnomad} => [qw{ download_gnomad }],
...
diag(   q{Test download_gnomad from Gnomad.pm v}
      . $MIP::Recipes::Download::Gnomad::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{gnomad};
my $reference_version = q{r2.0.1};
