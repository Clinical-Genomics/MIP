...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Vep} => [qw{ analysis_vep_sv_wes }],
...
use MIP::Recipes::Analysis::Vep qw{ analysis_vep_sv_wes };

diag(   q{Test analysis_vep_sv_wes from Vep.pm v}
