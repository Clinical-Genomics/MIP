...
## Modules with import
    my %perl_module = ( q{MIP::Test::Fixtures} => [qw{ }], );

    test_import( { perl_module_href => \%perl_module, } );
}

use MIP::Program::Gatk qw{ gatk_printreads };

diag(   q{Test gatk_printreads from Alignment::Gatk.pm}
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
## Base arguments
my @function_base_commands = qw{ gatk PrintReads };
