...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Stringtie} => [qw{ analysis_stringtie }],
...
diag(   q{Test analysis_stringtie from Stringtie.pm v}
      . $MIP::Recipes::Analysis::Stringtie::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
