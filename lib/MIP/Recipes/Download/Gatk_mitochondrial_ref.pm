package MIP::Recipes::Download::Gatk_mitochondrial_ref;
...
BEGIN {
    ...
    our @EXPORT_OK = qw{ download_gatk_mitochondrial_ref };

}

sub download_gatk_mitochondrial_ref {

## Function : Download mitochondrial references for GATK
## Returns  :
