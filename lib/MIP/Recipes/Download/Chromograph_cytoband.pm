package MIP::Recipes::Download::Chromograph_cytoband;
...
BEGIN {
    ...
    our @EXPORT_OK = qw{ download_chromograph_cytoband };

}

sub download_chromograph_cytoband {

## Function : Download chromograph cytoband files
## Returns  :
