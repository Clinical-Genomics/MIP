package MIP::Recipes::Download::Rank_model;
...
BEGIN {
    ...
    our @EXPORT_OK = qw{ download_rank_model };

}

sub download_rank_model {

## Function : Download rank model to score snv/indel variants
## Returns  :
