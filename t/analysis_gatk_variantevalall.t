...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Gatk_variantevalall} =>
...
diag(   q{Test analysis_gatk_variantevalall from Gatk_variantevalall.pm v}
      . $MIP::Recipes::Analysis::Gatk_variantevalall::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name    = q{gatk_variantevalall};
...
my $is_ok = analysis_gatk_variantevalall(
    {
