...
diag(   q{Test analysis_gatk_baserecalibration_panel from Gatk_baserecalibration.pm v}
...
$file_info{io}{TEST}{$sample_id}{$recipe_name}{in}{file_path} = q{a_file.bam};
...
my $is_ok = analysis_gatk_baserecalibration_panel(
    {
