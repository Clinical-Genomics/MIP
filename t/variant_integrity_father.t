...
## Modules with import
    my %perl_module = (
        q{MIP::Program::Variantcalling::Variant_integrity} =>
...
use MIP::Program::Variantcalling::Variant_integrity qw{ variant_integrity_father };
...
my %required_argument = (
    ...
    case_file => {
        input           => q{case_file},
        expected_output => q{--family_file case_file},
    },
);
