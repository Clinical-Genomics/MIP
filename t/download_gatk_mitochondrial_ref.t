...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Gatk_mitochondrial_ref} =>
...
diag(   q{Test download_gatk_mitochondrial_ref from Gatk_mitochondrial_ref.pm v}
      . $MIP::Recipes::Download::Gatk_mitochondrial_ref::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{gatk_mitochondrial_ref};
my $reference_version = q{v0_m_fasta};
...
my $is_ok = download_gatk_mitochondrial_ref(
    {
