...
## Modules with import
    my %perl_module = (
        q{MIP::Program::Qc::Rseqc} => [qw{ rseqc_read_distribution }],
...
use MIP::Program::Qc::Rseqc qw{ rseqc_read_distribution };
use MIP::Test::Commands qw{ test_function };

diag(   q{Test rseqc_read_distribution from Rseqc.pm v}
...
## Base arguments
my @function_base_commands = qw{ read_distribution.py };
...
my $module_function_cref = \&rseqc_read_distribution;
