...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Mip_vcfparser} => [qw{ analysis_mip_vcfparser_panel }],
...
diag(   q{Test analysis_mip_vcfparser_panel from Mip_vcfparser.pm v}
...
@{ $active_parameter{vcfparser_select_feature_annotation_columns} } = ( 1, 2 );
...
my $is_ok = analysis_mip_vcfparser_panel(
    {
