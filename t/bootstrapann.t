...
## Modules
    my @modules = (q{MIP::Program::Variantcalling::BootstrapAnn});
...
diag(   q{Test bootrstrapann from Variantcalling::BootstrapAnn.pm v}
      . $MIP::Program::Variantcalling::BootstrapAnn::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
