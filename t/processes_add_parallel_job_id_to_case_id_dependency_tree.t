...
use MIP::Processmanagement::Processes qw{ add_parallel_job_id_to_case_id_dependency_tree };

diag(   q{Test add_parallel_job_id_to_case_id_dependency_tree from Processes.pm}
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
is( $no_push_result, q{job_id_6}, q{No parallel job_ids} );
...
my $pan_push_result = join $SPACE, @{ $job_id{$case_id_chain_key}{$case_id_chain_key} };
is( $pan_push_result, q{job_id_6 job_id_10 job_id_11}, q{Pushed parallel job_id to sample_id} );
