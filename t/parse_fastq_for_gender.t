...
## Modules with import
    my %perl_module = (
        q{MIP::Parse::File}    => [qw{ parse_fastq_for_gender }],
...
use MIP::Parse::File qw{ parse_fastq_for_gender };

diag(   q{Test parse_fastq_for_gender from File.pm v}
...
$sample_info{gender}{others} = [$sample_id];
