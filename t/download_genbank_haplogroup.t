...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Genbank_haplogroup} => [qw{ download_genbank_haplogroup }],
...
diag(   q{Test download_genbank_haplogroup from Genbank_haplogroup.pm v}
      . $MIP::Recipes::Download::Genbank_haplogroup::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{genbank_haplogroup};
my $reference_version = q{20150801};
...
my $is_ok = download_genbank_haplogroup(
    {
