...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Pfam} => [qw{ download_pfam }],
...
diag(   q{Test download_pfam from Pfam.pm v}
      . $MIP::Recipes::Download::Pfam::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{pfam};
my $reference_version = q{32};
