...
## Modules with import
    my %perl_module = (
        q{MIP::Reference}      => [qw{ get_dict_contigs }],
...
diag(   q{Test get_dict_contigs from Reference.pm v}
...
@{ $file_info{contigs} } = get_dict_contigs(
    {
...
is_deeply( \@expected_contigs, \@{ $file_info{contigs} }, q{Got dict file contigs} );
