...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Chromograph_cytoband} =>
          [qw{ download_chromograph_cytoband }],
...
diag(   q{Test download_chromograph_cytoband from Chromograph_cytoband.pm v}
      . $MIP::Recipes::Download::Chromograph_cytoband::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{chromograph_cytoband};
my $reference_version = q{v1.0};
...
my $is_ok = download_chromograph_cytoband(
    {
