package MIP::Recipes::Download::Scout_exons;
...
BEGIN {
    ...
    our @EXPORT_OK = qw{ download_scout_exons };

}

sub download_scout_exons {

## Function : Download Scout exons used in gene panels
## Returns  :
