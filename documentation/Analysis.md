...
```Bash
$ mip analyse rd_dna [case_id] --config_file [mip_config_rd_dna] --rio
```
...
```Bash
$ mip analyse rd_dna [case_id] --config_file [mip_config_rd_dna] --rio --markduplicates 0
```

### Skipping a already processed recipe i.e expect that the ouput has already been generated

```Bash
$ mip analyse rd_dna [case_id] --config_file [mip_config_rd_dna] --rio --markduplicates 2
```

### Simulate standard analysis

```Bash
$ mip analyse rd_dna [case_id] --config_file [mip_config_rd_dna] --rio --dra
```
...
```Bash
$ mip analyse rd_dna [case_id] --config_file [mip_config_rd_dna] --rio --pr
```
