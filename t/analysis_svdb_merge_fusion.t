...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Svdb_merge_fusion} => [qw{ analysis_svdb_merge_fusion }],
...
diag(   q{Test analysis_svdb_merge_fusion from Svdb_merge_fusion.pm}
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name    = q{svdb_merge_fusion};
...
delete @{ $active_parameter{sample_ids} }[ 1, 2 ];
...
my $is_ok = analysis_svdb_merge_fusion(
    {
