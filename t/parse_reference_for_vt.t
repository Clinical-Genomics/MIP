...
use MIP::Test::Fixtures qw{ test_add_io_for_recipe test_constants test_log test_mip_hashes test_standard_cli };
...
diag(   q{Test parse_reference_for_vt from Reference.pm v}
      . $MIP::Parse::Reference::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
$active_parameter{gatk_varianteval_dbsnp} = catfile($Bin, qw{ data references grch37_mills_and_1000g_-gold_standard_indels-.vcf});
