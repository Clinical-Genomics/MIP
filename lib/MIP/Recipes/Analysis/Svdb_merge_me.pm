package MIP::Recipes::Analysis::Svdb_merge_me;
...
BEGIN {
    ...
    our @EXPORT_OK = qw{ analysis_me_merge_vcfs };

}

sub analysis_me_merge_vcfs {

## Function : Merge sample vcfs from RetroSeq to generate a case vcf.
## Returns  :
...
##          : $sample_info_href        => Info on samples and case hash {REF}
  ...
  SAMPLE_ID:
    foreach my $sample_id ( @{ $active_parameter_href->{sample_ids} } ) {
        ...
        push @me_infile_paths, $sample_io{in}{file_path};
    }
