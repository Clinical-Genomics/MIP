...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Gnomad_pli_per_gene} =>
          [qw{ download_gnomad_pli_per_gene }],
...
diag(   q{Test download_gnomad_pli_per_gene from Gnomad_pli_per_gene.pm v}
      . $MIP::Recipes::Download::Gnomad_pli_per_gene::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{gnomad_pli_per_gene};
my $reference_version = q{r2.1.1};
...
my $is_ok = download_gnomad_pli_per_gene(
    {
