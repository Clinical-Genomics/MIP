...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Vep} => [qw{ analysis_vep_me }],
...
use MIP::Recipes::Analysis::Vep qw{ analysis_vep_me };

diag(   q{Test analysis_vep_me from Vep.pm}
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name    = q{me_varianteffectpredictor};
