...
diag(   q{Test picardtools_addorreplacereadgroups from Picardtools.pm v}
...
my %required_argument = (
    infile_path => {
        ...
        expected_output => q{INPUT=} . catfile(qw{ dir test.bam }),
    },
    outfile_path => {
        input           => catfile(qw{ dir test.rg.bam }),
        expected_output => q{OUTPUT=} . catfile(qw{ dir test.rg.bam }),
    },
    readgroup_id => {
        input           => 1,
