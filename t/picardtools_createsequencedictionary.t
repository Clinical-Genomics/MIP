...
## Modules with import
    my %perl_module = (
        q{MIP::Program::Picardtools} => [qw{ picardtools_createsequencedictionary }],
...
diag(   q{Test picardtools_createsequencedictionary from Picardtools.pm v}
...
## Base arguments
my @function_base_commands = qw{ picard CreateSequenceDictionary };
