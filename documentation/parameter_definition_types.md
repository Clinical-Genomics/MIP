...
The following lines are generated by looping over the nested hashes generated while testing the yaml definition file "define_parameters.yaml" with the test "check_parameter_hash.t" with the . 
...
key1:pfastqc	key2:program_name_path;	value=ARRAY(0x7ff32a56b670)
key1:pfastqc	key2:chain;	value=RawSeqQC
key1:pfastqc	key2:file_tag;	value=nofile_tag
key1:pfastqc	key2:infile_suffix;	value=.fastq
key1:pfastqc	key2:type;	value=program
key1:pfastqc	key2:associated_program;	value=ARRAY(0x7ff32a56b628)
key1:pfastqc	key2:data_type;	value=SCALAR
key1:pfastqc	key2:default;	value=0
key1:endvariantannotationblock_remove_genes_file	key2:mandatory;	value=no
key1:endvariantannotationblock_remove_genes_file	key2:associated_program;	value=ARRAY(0x7ff32a57b2e8)
key1:endvariantannotationblock_remove_genes_file	key2:reference;	value=reference_dir
key1:endvariantannotationblock_remove_genes_file	key2:exists_check;	value=file
key1:endvariantannotationblock_remove_genes_file	key2:data_type;	value=SCALAR
key1:endvariantannotationblock_remove_genes_file	key2:type;	value=path
key1:gatk_combinevariants_genotype_merge_option	key2:type;	value=program_argument
key1:gatk_combinevariants_genotype_merge_option	key2:default;	value=PRIORITIZE
key1:gatk_combinevariants_genotype_merge_option	key2:data_type;	value=SCALAR
key1:gatk_combinevariants_genotype_merge_option	key2:mandatory;	value=no
key1:gatk_combinevariants_genotype_merge_option	key2:associated_program;	value=ARRAY(0x7ff32a574d20)
key1:gatk_combinevariants_prioritize_caller	key2:type;	value=program_argument
key1:gatk_combinevariants_prioritize_caller	key2:data_type;	value=SCALAR
key1:gatk_combinevariants_prioritize_caller	key2:mandatory;	value=no
key1:gatk_combinevariants_prioritize_caller	key2:associated_program;	value=ARRAY(0x7ff32a574f30)
key1:pendvariantannotationblock	key2:chain;	value=MAIN
key1:pendvariantannotationblock	key2:file_tag;	value=nofile_tag
key1:pendvariantannotationblock	key2:program_name_path;	value=ARRAY(0x7ff32a57b150)
key1:pendvariantannotationblock	key2:type;	value=program
key1:pendvariantannotationblock	key2:outfile_suffix;	value=.vcf
key1:pendvariantannotationblock	key2:associated_program;	value=ARRAY(0x7ff32a57a0e8)
key1:pendvariantannotationblock	key2:data_type;	value=SCALAR
key1:pendvariantannotationblock	key2:default;	value=0
key1:sv_vcfanno_config	key2:associated_program;	value=ARRAY(0x7ff32a570750)
key1:sv_vcfanno_config	key2:reference;	value=reference_dir
key1:sv_vcfanno_config	key2:type;	value=path
key1:sv_vcfanno_config	key2:data_type;	value=SCALAR
key1:sv_vcfanno_config	key2:exists_check;	value=file
key1:vep_plugins	key2:associated_program;	value=ARRAY(0x7ff32a577348)
key1:vep_plugins	key2:default;	value=ARRAY(0x7ff32a576e98)
key1:vep_plugins	key2:type;	value=program_argument
key1:vep_plugins	key2:data_type;	value=ARRAY
key1:vep_plugins	key2:element_separator;	value=,
key1:pvarianteffectpredictor	key2:file_endings;	value=ARRAY(0x7ff32a5525f8)
key1:pvarianteffectpredictor	key2:file_tag;	value=vep_
key1:pvarianteffectpredictor	key2:chain;	value=MAIN
key1:pvarianteffectpredictor	key2:type;	value=program
key1:pvarianteffectpredictor	key2:associated_program;	value=ARRAY(0x7ff32a576fe8)
key1:pvarianteffectpredictor	key2:outfile_suffix;	value=.vcf
key1:pvarianteffectpredictor	key2:data_type;	value=SCALAR
key1:pvarianteffectpredictor	key2:default;	value=0
key1:pvariant_integrity	key2:type;	value=program
key1:pvariant_integrity	key2:data_type;	value=SCALAR
key1:pvariant_integrity	key2:default;	value=0
key1:pvariant_integrity	key2:associated_program;	value=ARRAY(0x7ff32a579770)
key1:pvariant_integrity	key2:chain;	value=VIQC
key1:pvariant_integrity	key2:file_tag;	value=nofile_tag
key1:pfrequency_filter	key2:outfile_suffix;	value=.vcf
key1:pfrequency_filter	key2:associated_program;	value=ARRAY(0x7ff32a576640)
key1:pfrequency_filter	key2:data_type;	value=SCALAR
key1:pfrequency_filter	key2:default;	value=0
key1:pfrequency_filter	key2:file_tag;	value=frqf_
key1:pfrequency_filter	key2:chain;	value=MAIN
key1:pfrequency_filter	key2:file_endings;	value=ARRAY(0x7ff32a5765c8)
key1:pfrequency_filter	key2:type;	value=program
key1:pcutadapt	key2:file_tag;	value=_cuta
key1:pcutadapt	key2:chain;	value=MAIN
key1:pcutadapt	key2:program_name_path;	value=ARRAY(0x7ff32a56b790)
key1:pcutadapt	key2:type;	value=program
key1:pcutadapt	key2:infile_suffix;	value=.fastq
key1:pcutadapt	key2:associated_program;	value=ARRAY(0x7ff32a56b748)
key1:pcutadapt	key2:data_type;	value=SCALAR
key1:pcutadapt	key2:default;	value=0
key1:snpsift_annotation_outinfo_key	key2:reference;	value=reference_dir
key1:snpsift_annotation_outinfo_key	key2:type;	value=path
key1:snpsift_annotation_outinfo_key	key2:data_type;	value=HASH
key1:snpsift_annotation_outinfo_key	key2:default;	value=HASH(0x7ff32a578e00)
key1:snpsift_annotation_outinfo_key	key2:exists_check;	value=file
key1:snpsift_annotation_outinfo_key	key2:associated_program;	value=ARRAY(0x7ff32a578de8)
key1:family_id	key2:data_type;	value=SCALAR
key1:family_id	key2:type;	value=mip
key1:family_id	key2:associated_program;	value=ARRAY(0x7ff32a558a10)
key1:pprepareforvariantannotationblock	key2:chain;	value=MAIN
key1:pprepareforvariantannotationblock	key2:outfile_suffix;	value=.vcf.gz
key1:pprepareforvariantannotationblock	key2:file_tag;	value=nofile_tag
key1:pprepareforvariantannotationblock	key2:associated_program;	value=ARRAY(0x7ff32a575140)
key1:pprepareforvariantannotationblock	key2:type;	value=program
key1:pprepareforvariantannotationblock	key2:default;	value=0
key1:pprepareforvariantannotationblock	key2:data_type;	value=SCALAR
key1:snpeff_ann	key2:type;	value=program_argument
key1:snpeff_ann	key2:data_type;	value=SCALAR
key1:snpeff_ann	key2:default;	value=0
key1:snpeff_ann	key2:associated_program;	value=ARRAY(0x7ff32a578ba8)
key1:outdata_dir	key2:type;	value=path
key1:outdata_dir	key2:data_type;	value=SCALAR
key1:outdata_dir	key2:associated_program;	value=ARRAY(0x7ff32a558a88)
key1:outdata_dir	key2:update_path;	value=absolute_path
key1:sv_genmod_models_reduced_penetrance_file	key2:associated_program;	value=ARRAY(0x7ff32a572610)
key1:sv_genmod_models_reduced_penetrance_file	key2:exists_check;	value=file
key1:sv_genmod_models_reduced_penetrance_file	key2:data_type;	value=SCALAR
key1:sv_genmod_models_reduced_penetrance_file	key2:type;	value=path
key1:sv_genmod_models_reduced_penetrance_file	key2:reference;	value=reference_dir
key1:nist_high_confidence_call_set_bed	key2:exists_check;	value=file
key1:nist_high_confidence_call_set_bed	key2:default;	value=GRCh37_nist_hg001_-na12878_v2.19-.bed
key1:nist_high_confidence_call_set_bed	key2:type;	value=path
key1:nist_high_confidence_call_set_bed	key2:data_type;	value=SCALAR
key1:nist_high_confidence_call_set_bed	key2:reference;	value=reference_dir
key1:nist_high_confidence_call_set_bed	key2:associated_program;	value=ARRAY(0x7ff32a579cb0)
key1:gatk_baserecalibration_disable_indel_qual	key2:associated_program;	value=ARRAY(0x7ff32a56c988)
key1:gatk_baserecalibration_disable_indel_qual	key2:type;	value=program_argument
key1:gatk_baserecalibration_disable_indel_qual	key2:data_type;	value=SCALAR
key1:gatk_baserecalibration_disable_indel_qual	key2:default;	value=0
key1:email	key2:mandatory;	value=no
key1:email	key2:associated_program;	value=ARRAY(0x7ff32a56af98)
key1:email	key2:type;	value=mip
key1:email	key2:data_type;	value=SCALAR
key1:bwa_build_reference	key2:exists_check;	value=file
key1:bwa_build_reference	key2:data_type;	value=SCALAR
key1:bwa_build_reference	key2:type;	value=path
key1:bwa_build_reference	key2:build_file;	value=1
key1:bwa_build_reference	key2:reference;	value=reference_dir
key1:bwa_build_reference	key2:associated_program;	value=ARRAY(0x7ff32a56bc88)
key1:psv_vcfparser	key2:type;	value=program
key1:psv_vcfparser	key2:default;	value=0
key1:psv_vcfparser	key2:data_type;	value=SCALAR
key1:psv_vcfparser	key2:chain;	value=SV
key1:psv_vcfparser	key2:file_tag;	value=parsed_
key1:psv_vcfparser	key2:associated_program;	value=ARRAY(0x7ff32a571d88)
key1:frequency_genmod_filter_1000g	key2:associated_program;	value=ARRAY(0x7ff32a5767d8)
key1:frequency_genmod_filter_1000g	key2:exists_check;	value=file
key1:frequency_genmod_filter_1000g	key2:default;	value=GRCh37_all_wgs_-phase3_v5b.2013-05-02-.vcf.gz
key1:frequency_genmod_filter_1000g	key2:type;	value=path
key1:frequency_genmod_filter_1000g	key2:data_type;	value=SCALAR
key1:frequency_genmod_filter_1000g	key2:reference;	value=reference_dir
key1:psv_reformat	key2:data_type;	value=SCALAR
key1:psv_reformat	key2:type;	value=program
key1:psv_reformat	key2:default;	value=0
key1:psv_reformat	key2:chain;	value=SV
key1:psv_reformat	key2:file_tag;	value=
key1:psv_reformat	key2:associated_program;	value=ARRAY(0x7ff32a572550)
key1:psv_reformat	key2:program_name_path;	value=ARRAY(0x7ff32a572598)
key1:module_source_environment_command	key2:data_type;	value=HASH
key1:module_source_environment_command	key2:type;	value=mip
key1:module_source_environment_command	key2:mandatory;	value=no
key1:module_source_environment_command	key2:associated_program;	value=ARRAY(0x7ff32a56b220)
key1:gatk_path	key2:update_path;	value=absolute_path
key1:gatk_path	key2:associated_program;	value=ARRAY(0x7ff32a579230)
key1:gatk_path	key2:exists_check;	value=directory
key1:gatk_path	key2:type;	value=path
key1:gatk_path	key2:data_type;	value=SCALAR
key1:sample_info_file	key2:associated_program;	value=ARRAY(0x7ff32a5594f0)
key1:sample_info_file	key2:update_path;	value=absolute_path
key1:sample_info_file	key2:type;	value=path
key1:sample_info_file	key2:data_type;	value=SCALAR
key1:gatk_variantrecalibration_indel_max_gaussians	key2:data_type;	value=SCALAR
key1:gatk_variantrecalibration_indel_max_gaussians	key2:type;	value=program_argument
key1:gatk_variantrecalibration_indel_max_gaussians	key2:default;	value=0
key1:gatk_variantrecalibration_indel_max_gaussians	key2:associated_program;	value=ARRAY(0x7ff32a574c30)
key1:vt_normalize	key2:type;	value=program_argument
key1:vt_normalize	key2:default;	value=0
key1:vt_normalize	key2:data_type;	value=SCALAR
key1:vt_normalize	key2:associated_program;	value=ARRAY(0x7ff32a576490)
key1:gatk_disable_auto_index_and_file_lock	key2:type;	value=program_argument
key1:gatk_disable_auto_index_and_file_lock	key2:default;	value=0
key1:gatk_disable_auto_index_and_file_lock	key2:data_type;	value=SCALAR
key1:gatk_disable_auto_index_and_file_lock	key2:associated_program;	value=ARRAY(0x7ff32a576e08)
key1:pbcftools_mpileup	key2:default;	value=0
key1:pbcftools_mpileup	key2:data_type;	value=SCALAR
key1:pbcftools_mpileup	key2:associated_program;	value=ARRAY(0x7ff32a5728f0)
key1:pbcftools_mpileup	key2:outdir_name;	value=bcftools
key1:pbcftools_mpileup	key2:outfile_suffix;	value=.vcf
key1:pbcftools_mpileup	key2:type;	value=program
key1:pbcftools_mpileup	key2:program_type;	value=variant_callers
key1:pbcftools_mpileup	key2:program_name_path;	value=ARRAY(0x7ff32a5729f8)
key1:pbcftools_mpileup	key2:file_endings;	value=ARRAY(0x7ff32a535548)
key1:pbcftools_mpileup	key2:file_tag;	value=_mpileup_
key1:pbcftools_mpileup	key2:chain;	value=SAMMP
key1:prtg_vcfeval	key2:program_name_path;	value=ARRAY(0x7ff32a5797d0)
key1:prtg_vcfeval	key2:associated_program;	value=ARRAY(0x7ff32a579878)
key1:prtg_vcfeval	key2:file_tag;	value=nofile_tag
key1:prtg_vcfeval	key2:chain;	value=RTG_EVAL_NIST
key1:prtg_vcfeval	key2:data_type;	value=SCALAR
key1:prtg_vcfeval	key2:type;	value=program
key1:prtg_vcfeval	key2:default;	value=0
key1:bwa_mem_hla	key2:default;	value=0
key1:bwa_mem_hla	key2:type;	value=program_argument
key1:bwa_mem_hla	key2:data_type;	value=SCALAR
key1:bwa_mem_hla	key2:associated_program;	value=ARRAY(0x7ff32a56b5e0)
key1:sv_vep_plugins	key2:associated_program;	value=ARRAY(0x7ff32a571b30)
key1:sv_vep_plugins	key2:element_separator;	value=,
key1:sv_vep_plugins	key2:type;	value=program_argument
key1:sv_vep_plugins	key2:default;	value=ARRAY(0x7ff32a5351e8)
key1:sv_vep_plugins	key2:data_type;	value=ARRAY
key1:sv_genmod_filter_1000g	key2:associated_program;	value=ARRAY(0x7ff32a571818)
key1:sv_genmod_filter_1000g	key2:exists_check;	value=file
key1:sv_genmod_filter_1000g	key2:default;	value=GRCh37_all_wgs_-phase3_v5b.2013-05-02-.vcf.gz
key1:sv_genmod_filter_1000g	key2:type;	value=path
key1:sv_genmod_filter_1000g	key2:data_type;	value=SCALAR
key1:sv_genmod_filter_1000g	key2:reference;	value=reference_dir
key1:sv_reformat_remove_genes_file	key2:exists_check;	value=file
key1:sv_reformat_remove_genes_file	key2:data_type;	value=SCALAR
key1:sv_reformat_remove_genes_file	key2:type;	value=path
key1:sv_reformat_remove_genes_file	key2:reference;	value=reference_dir
key1:sv_reformat_remove_genes_file	key2:mandatory;	value=no
key1:sv_reformat_remove_genes_file	key2:associated_program;	value=ARRAY(0x7ff32a572920)
key1:gatk_baserecalibration_covariates	key2:element_separator;	value=,
key1:gatk_baserecalibration_covariates	key2:type;	value=program_argument
key1:gatk_baserecalibration_covariates	key2:default;	value=ARRAY(0x7ff32a56c490)
key1:gatk_baserecalibration_covariates	key2:data_type;	value=ARRAY
key1:gatk_baserecalibration_covariates	key2:associated_program;	value=ARRAY(0x7ff32a56c6a0)
key1:cluster_constant_path	key2:type;	value=path
key1:cluster_constant_path	key2:data_type;	value=SCALAR
key1:cluster_constant_path	key2:associated_program;	value=ARRAY(0x7ff32a5588f0)
key1:sv_genmod_filter	key2:associated_program;	value=ARRAY(0x7ff32a570960)
key1:sv_genmod_filter	key2:default;	value=0
key1:sv_genmod_filter	key2:type;	value=program_argument
key1:sv_genmod_filter	key2:data_type;	value=SCALAR
key1:gatk_downsample_to_coverage	key2:associated_program;	value=ARRAY(0x7ff32a576d48)
key1:gatk_downsample_to_coverage	key2:data_type;	value=SCALAR
key1:gatk_downsample_to_coverage	key2:type;	value=program_argument
key1:gatk_downsample_to_coverage	key2:default;	value=1000
key1:nist_high_confidence_call_set	key2:reference;	value=reference_dir
key1:nist_high_confidence_call_set	key2:exists_check;	value=file
key1:nist_high_confidence_call_set	key2:type;	value=path
key1:nist_high_confidence_call_set	key2:data_type;	value=SCALAR
key1:nist_high_confidence_call_set	key2:default;	value=GRCh37_nist_hg001_-na12878_v2.19-.vcf
key1:nist_high_confidence_call_set	key2:associated_program;	value=ARRAY(0x7ff32a579bd8)
key1:qccollect_skip_evaluation	key2:associated_program;	value=ARRAY(0x7ff32a57b5d0)
key1:qccollect_skip_evaluation	key2:type;	value=program_argument
key1:qccollect_skip_evaluation	key2:data_type;	value=SCALAR
key1:qccollect_skip_evaluation	key2:default;	value=0
key1:config_file	key2:update_path;	value=absolute_path
key1:config_file	key2:associated_program;	value=ARRAY(0x7ff32a558c20)
key1:config_file	key2:default;	value=0
key1:config_file	key2:type;	value=path
key1:config_file	key2:data_type;	value=SCALAR
key1:project_id	key2:type;	value=mip
key1:project_id	key2:data_type;	value=SCALAR
key1:project_id	key2:associated_program;	value=ARRAY(0x7ff32a558ba8)
key1:gatk_realigner_indel_known_sites	key2:associated_program;	value=ARRAY(0x7ff32a56c4a8)
key1:gatk_realigner_indel_known_sites	key2:element_separator;	value=,
key1:gatk_realigner_indel_known_sites	key2:exists_check;	value=file
key1:gatk_realigner_indel_known_sites	key2:type;	value=path
key1:gatk_realigner_indel_known_sites	key2:data_type;	value=ARRAY
key1:gatk_realigner_indel_known_sites	key2:default;	value=ARRAY(0x7ff32a503360)
key1:gatk_realigner_indel_known_sites	key2:reference;	value=reference_dir
key1:bash_set_nounset	key2:associated_program;	value=ARRAY(0x7ff32a55aa80)
key1:bash_set_nounset	key2:type;	value=mip
key1:bash_set_nounset	key2:data_type;	value=SCALAR
key1:bash_set_nounset	key2:default;	value=0
key1:sv_svdb_query	key2:associated_program;	value=ARRAY(0x7ff32a5704e0)
key1:sv_svdb_query	key2:default;	value=0
key1:sv_svdb_query	key2:type;	value=program_argument
key1:sv_svdb_query	key2:data_type;	value=SCALAR
key1:gatk_haplotypecaller_pcr_indel_model	key2:associated_program;	value=ARRAY(0x7ff32a573280)
key1:gatk_haplotypecaller_pcr_indel_model	key2:type;	value=program_argument
key1:gatk_haplotypecaller_pcr_indel_model	key2:data_type;	value=SCALAR
key1:gatk_haplotypecaller_pcr_indel_model	key2:default;	value=NONE
key1:sv_vep_features	key2:associated_program;	value=ARRAY(0x7ff32a571ab8)
key1:sv_vep_features	key2:default;	value=ARRAY(0x7ff32a571a10)
key1:sv_vep_features	key2:type;	value=program_argument
key1:sv_vep_features	key2:data_type;	value=ARRAY
key1:sv_vep_features	key2:element_separator;	value=,
