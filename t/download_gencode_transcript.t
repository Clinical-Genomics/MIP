...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Gencode_transcript} => [qw{ download_gencode_transcript }],
...
diag(   q{Test download_gencode_transcript from Gencode_transcript.pm}
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{gencode_transcript};
my $reference_version = q{v37};
...
my $is_ok = download_gencode_transcript(
    {
