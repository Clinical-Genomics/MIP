...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Megafusion} => [qw{ analysis_megafusion }],
...
diag(   q{Test analysis_megafusion from Megafusion.pm}
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name    = q{megafusion_ar};
