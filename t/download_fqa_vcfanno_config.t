...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Fqa_vcfanno_config} =>
          [qw{ download_fqa_vcfanno_config }],
...
diag(   q{Test download_fqa_vcfanno_config from Fqa_vcfanno_config.pm v}
      . $MIP::Recipes::Download::Fqa_vcfanno_config::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{fqa_vcfanno_config};
...
my $is_ok = download_fqa_vcfanno_config(
    {
