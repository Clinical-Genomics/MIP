...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Frequency_filter} =>
          [qw{ analysis_frequency_filter_panel }],
...
diag(   q{Test analysis_frequency_filter_panel from Frequency_filter.pm v}
...
my $is_ok = analysis_frequency_filter_panel(
    {
