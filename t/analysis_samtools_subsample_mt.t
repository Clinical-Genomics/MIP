...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Samtools_subsample_mt} =>
...
diag(   q{Test analysis_samtools_subsample_mt from Samtools_subsample_mt.pm v}
      . $MIP::Recipes::Analysis::Samtools_subsample_mt::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
$active_parameter{samtools_subsample_mt_depth} = 1;
