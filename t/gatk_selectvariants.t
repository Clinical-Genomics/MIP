...
diag(   q{Test gatk_selectvariants from Gatk v}
...
my %required_argument = (
    sample_names_ref => {
        inputs_ref => [qw{ sample1 sample2 sample3 }],
        expected_output =>
          q{--sample_name sample1 --sample_name sample2 --sample_name sample3},
    },
    infile_path => {
        input           => q{infile_path},
        expected_output => q{--variant infile_path},
    },
    outfile_path => {
        input           => q{outfile},
