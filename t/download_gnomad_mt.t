...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Gnomad} => [qw{ download_gnomad_mt }],
...
use MIP::Recipes::Download::Gnomad qw{ download_gnomad_mt };

diag(   q{Test download_gnomad_mt from Gnomad.pm}
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{gnomad_mt};
my $reference_version = q{r3.1};
