...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Rank_model} => [qw{ download_rank_model }],
...
diag(   q{Test download_rank_model from Rank_model.pm v}
      . $MIP::Recipes::Download::Rank_model::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{rank_model};
my $reference_version = q{v1.25};
