    ...
    @commands = gatk_base(
        {
            ...
            intervals_ref       => $intervals_ref,
            referencefile_path  => $referencefile_path,
            exclude_nonvariants => $exclude_nonvariants,
            sample_names_ref    => $sample_names_ref,
    ...
    @commands = gatk_base(
        {
            ...
            tranches_file_path         => $tranches_file_path,
    ...
    @commands = gatk_base(
        {
            ...
            intervals_ref                => $intervals_ref,
            referencefile_path           => $referencefile_path,
            supporting_callset_file_path => $supporting_callset_file_path,
            infile_path                  => $infile_path,
            outfile_path                 => $outfile_path,
            FILEHANDLE                   => $FILEHANDLE,
        }
    ...
    @commands = gatk_base(
        {
            ...
            referencefile_path    => $referencefile_path,
            exclude_nonvariants   => $exclude_nonvariants,
            genotype_merge_option => $genotype_merge_option,
            prioritize_caller     => $prioritize_caller,
            infile_paths_ref      => $infile_paths_ref,
            outfile_path          => $outfile_path,
            FILEHANDLE            => $FILEHANDLE,
        }
    ...
    @commands = gatk_base(
        {
            ...
            referencefile_path            => $referencefile_path,
            dbsnp_file_path               => $dbsnp_file_path,
            indel_gold_standard_file_path => $indel_gold_standard_file_path,
            infile_paths_ref              => $infile_paths_ref,
            outfile_path                  => $outfile_path,
            FILEHANDLE                    => $FILEHANDLE,
        }
