...
## Then return 1
ok( $has_duo, q{Detect duo} );

## Given two samples but no affected phenotype
...
## Then return 0
is( $has_duo, 0, q{Detect not affected} );
...
## Then return 0
is( $has_duo, 0, q{Detect not trio} );
