...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Gatk_cnnscorevariants} =>
...
diag(   q{Test analysis_gatk_cnnscorevariants from Gatk_cnnscorevariants.pm v}
      . $MIP::Recipes::Analysis::Gatk_cnnscorevariants::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name    = q{gatk_cnnscorevariants};
...
my $is_ok = analysis_gatk_cnnscorevariants(
    {
