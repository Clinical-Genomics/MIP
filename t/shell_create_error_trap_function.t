...
use File::Format::Shell qw(build_shebang enable_trap create_error_trap_function);

my $NEWLINE = q{\n};

diag(
"Test create_error_trap_function $File::Format::Shell::VERSION, Perl $^V, $EXECUTABLE_NAME"
);
