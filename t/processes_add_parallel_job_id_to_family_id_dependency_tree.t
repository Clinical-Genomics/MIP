...
use MIP::Processmanagement::Processes
  qw{add_parallel_job_id_to_family_id_dependency_tree};

diag(
"Test add_parallel_job_id_to_family_id_dependency_tree $MIP::Processmanagement::Processes::VERSION, Perl $^V, $EXECUTABLE_NAME"
);
...
add_parallel_job_id_to_family_id_dependency_tree(
    {
        ...
        family_id             => $family_id . q{no_parallel},
        path                  => $path,
