package MIP::Recipes::Download::Mills_and_1000g_indels;
...
BEGIN {
    ...
    our @EXPORT_OK = qw{ download_mills_and_1000g_indels };

}

sub download_mills_and_1000g_indels {

## Function : Download mills_and_1000g_indels from gatk
## Returns  :
