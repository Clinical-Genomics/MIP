...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Giab} => [qw{ download_giab }],
...
diag(   q{Test download_giab from Giab.pm v}
      . $MIP::Recipes::Download::Giab::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{giab};
my $reference_version = q{na12878_v3.3.2_wgs};
