...
## Indelrealigner for local multiple sequence realignment
...
## BaseRecalibrator to detect systematic errors in base quality score
...
## Chanjo sexcheck. Essentially, another check point where tumor vs normal sex should match
...
## Coverage depth using sambamba depth
...
## Genome coverage report from bedtools
...
## Collect multiple metrics about alignment
...
## CollectHsMetrics if targeted sequencing is done. Is this choice moot for WGS solutions?
...
## Combine SV identified above, variant effect predictor next, and sv VCF parser
...
## Somatic variant caller section starting with freebayes
