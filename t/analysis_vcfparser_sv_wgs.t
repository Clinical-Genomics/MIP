...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Mip_vcfparser} => [qw{ analysis_vcfparser_sv_wgs }],
...
use MIP::Recipes::Analysis::Mip_vcfparser qw{ analysis_vcfparser_sv_wgs };

diag(   q{Test analysis_vcfparser_sv_wgs from Mip_vcfparser.pm v}
...
my $is_ok = analysis_vcfparser_sv_wgs(
    {
