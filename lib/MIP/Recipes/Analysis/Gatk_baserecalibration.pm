...
BEGIN {
    ...
    our @EXPORT_OK =
      qw{ analysis_gatk_baserecalibration analysis_gatk_baserecalibration_rio analysis_gatk_baserecalibration_rna };
...
##          : $temp_directory          => Temporary directory
    ...
    migrate_file(
        {
            FILEHANDLE => $FILEHANDLE,
            infile_path =>
              catfile( $insample_directory, $infile_prefix . $ASTERIX ),
    ...
    my $outfile_path = $outfile_path_prefix . $DOT . q{grp};
    gatk_baserecalibrator(
        {
            covariates_ref =>
              \@{ $active_parameter_href->{gatk_baserecalibration_covariates} },
            ...
            FILEHANDLE => $FILEHANDLE,
            gatk_disable_auto_index_and_file_lock =>
              $active_parameter_href->{gatk_disable_auto_index_and_file_lock},
            infile_path => $infile_path,
            java_jar    => catfile(
                $active_parameter_href->{gatk_path},
                q{GenomeAnalysisTK.jar},
