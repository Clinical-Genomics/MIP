...
use MIP::Processmanagement::Processes
  qw{add_sample_ids_parallel_job_id_to_family_id_dependency_tree};

diag(
"Test add_sample_ids_parallel_job_id_to_family_id_dependency_tree $MIP::Processmanagement::Processes::VERSION, Perl $^V, $EXECUTABLE_NAME"
);
...
is(
    ...
    q{Pushed sample_ids parallel job_id to family_id}
);
