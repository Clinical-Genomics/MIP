...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Install::Docker} => [qw{ install_docker_containers }],
...
diag(   q{Test install_docker_containers from Docker.pm v}
      . $MIP::Recipes::Install::Docker::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $is_ok = install_docker_containers(
    {
