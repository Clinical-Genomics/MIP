...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Scout_exons} => [qw{ download_scout_exons }],
...
diag(   q{Test download_scout_exons from Scout_exons.pm v}
      . $MIP::Recipes::Download::Scout_exons::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{scout_exons};
my $reference_version = q{201701};
