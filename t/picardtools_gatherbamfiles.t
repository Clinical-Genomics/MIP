...
## Modules with import
    my %perl_module = (
        q{MIP::Program::Picardtools} => [qw{ picardtools_gatherbamfiles }],
);
...
diag(   q{Test picardtools_gatherbamfiles from Picardtools.pm}
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
## Base arguments
my @function_base_commands = qw{ picard GatherBamFiles };
...
my $module_function_cref = \&picardtools_gatherbamfiles;
