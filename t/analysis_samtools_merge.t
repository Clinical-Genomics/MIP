...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Samtools_merge} => [qw{ analysis_samtools_merge }],
...
diag(   q{Test analysis_samtools_merge from Samtools_merge.pm v}
...
my $recipe_name    = q{samtools_merge};
...
my $is_ok = analysis_samtools_merge(
    {
