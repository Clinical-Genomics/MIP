...
diag(   q{Test analysis_genebody_coverage from Rseqc.pm v}
...
my $log_msg = q{##\s+Genebody_coverage};
like( $trap->stderr, qr/$log_msg/msx, q{Broadcast genebody_coverage log message} );
