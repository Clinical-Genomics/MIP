...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::1000g_snps} => [qw{ download_1000g_snps }],
...
diag(   q{Test download_1000g_snps from 1000g_snps.pm v}
      . $MIP::Recipes::Download::1000g_snps::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{1000g_snps};
my $reference_version = q{phase1};
