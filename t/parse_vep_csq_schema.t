...
## Modules with import
    my %perl_module = ( q{MIP::Vcfparser} => [qw{ parse_vep_csq_schema }], );
...
is( $vep_format_field_column{HGNC_ID}, $HGNC_ID_CSQ_FIELD_INDEX, q{Set HGNC ID field in hash} );
