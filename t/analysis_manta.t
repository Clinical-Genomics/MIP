...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Manta} => [qw{ analysis_manta }],
...
diag(   q{Test analysis_manta from Manta.pm v}
      . $MIP::Recipes::Analysis::Manta::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
