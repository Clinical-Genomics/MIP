...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Mt_annotation} => [qw{ analysis_mt_annotation }],
...
diag(   q{Test analysis_mt_annotation from Mt_annotation.pm}
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
$parameter{$recipe_name}{outfile_suffix} .= q{.gz};

my %sample_info;

my $is_ok = analysis_mt_annotation(
    {
