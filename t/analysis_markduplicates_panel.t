...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Markduplicates} => [qw{ analysis_markduplicates_panel }],
...
diag(   q{Test analysis_markduplicates_panel from Markduplicates.pm v}
...
my $is_ok = analysis_markduplicates_panel(
    {
