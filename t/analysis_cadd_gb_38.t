...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Cadd} => [qw{ analysis_cadd_gb_38 }],
...
use MIP::Recipes::Analysis::Cadd qw{ analysis_cadd_gb_38 };

diag(   q{Test analysis_cadd_gb_38 from Cadd.pm v}
