...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Rankvariant} => [qw{ analysis_rankvariant }],
...
diag(   q{Test analysis_rankvariant from Rankvariant.pm v}
...
$active_parameter{rank_model_file}         = q{rank_model_file};
$active_parameter{varianteffectpredictor}  = 1;
