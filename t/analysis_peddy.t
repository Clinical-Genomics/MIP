...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Peddy} => [qw{ analysis_peddy }],
...
diag(   q{Test analysis_peddy from Peddy.pm v}
      . $MIP::Recipes::Analysis::Peddy::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
