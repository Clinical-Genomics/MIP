...
use MIP::Program::Variantcalling::Gatk qw{ gatk_leftalignandtrimvariants };
use MIP::Test::Commands qw{ test_function };

diag(   q{Test gatk_leftalignandtrimvariants from Gatk v}
...
my %required_argument = (
    infile_path => {
      input => q{infile},
      expected_output => q{--variant outfile},
    },
    outfile_path => {
      input => q{outfile},
...
my %specific_argument = (
    ...
    split_multiallelics => {
      input => 1,
      expected_output => q{--splitMultiallelics},
    },
