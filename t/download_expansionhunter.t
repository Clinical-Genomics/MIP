...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Expansionhunter} => [qw{ download_expansionhunter }],
...
diag(   q{Test download_expansionhunter from Expansionhunter.pm v}
      . $MIP::Recipes::Download::Expansionhunter::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $is_ok = download_expansionhunter(
    {
