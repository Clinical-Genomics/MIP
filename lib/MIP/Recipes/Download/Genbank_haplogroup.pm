package MIP::Recipes::Download::Genbank_haplogroup;
...
BEGIN {
    ...
    our @EXPORT_OK = qw{ download_genbank_haplogroup };

}

sub download_genbank_haplogroup {

## Function : Download genbank haplotype group frequency file
## Returns  :
