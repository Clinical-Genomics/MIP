    ...
    my @cmds = wget(
        {
            ...
            url          =>
q{https://raw.githubusercontent.com/Ensembl/VEP_plugins/release/110/LoFtool_scores.txt},
        }
    );
    ...
    my @cmds = wget(
        {
            ...
            url          =>
              q{https://raw.githubusercontent.com/Ensembl/VEP_plugins/release/110/pLI_values.txt},
        }
    );
