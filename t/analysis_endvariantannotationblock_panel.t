...
diag( q{Test analysis_endvariantannotationblock_panel from Endvariantannotationblock.pm}
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name    = q{endvariantannotationblock};
