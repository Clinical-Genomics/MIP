...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Gatk_variantevalexome} =>
...
diag(   q{Test analysis_gatk_variantevalexome from Gatk_variantevalexome.pm v}
      . $MIP::Recipes::Analysis::Gatk_variantevalexome::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name    = q{gatk_variantevalexome};
...
my $is_ok = analysis_gatk_variantevalexome(
    {
