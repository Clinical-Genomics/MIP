...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Rankvariant} => [qw{ analysis_rankvariant_sv }],
...
use MIP::Recipes::Analysis::Rankvariant qw{ analysis_rankvariant_sv };

diag(   q{Test analysis_rankvariant_sv from Rankvariant.pm v}
...
my $is_ok = analysis_rankvariant_sv(
    {
