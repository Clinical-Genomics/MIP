...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::1000g_omni} => [qw{ download_1000g_omni }],
...
diag(   q{Test download_1000g_omni from 1000g_omni.pm v}
      . $MIP::Recipes::Download::1000g_omni::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{1000g_omni};
my $reference_version = q{2.5};
