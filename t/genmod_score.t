...
use MIP::Program::Variantcalling::Genmod qw{ genmod_score };
use MIP::Test::Commands qw{ test_function };

diag(   q{Test genmod_score from Genmod.pm v}
...
my %required_argument = (
    ...
    family_file => {
        input           => catfile(qw{ a test family_file }),
        expected_output => q{--family_file}
          . $SPACE
          . catfile(qw{ a test family_file }),
    },
    rank_model_file_path => {
        input           => catfile(qw{ a test rank_file }),
        expected_output => q{--score_config}
          . $SPACE
          . catfile(qw{ a test rank_file }),
    },
);
