...
## Modules with import
    my %perl_module = (
        q{MIP::Program::Qc::Rseqc} => [qw{ rseqc_junction_saturation }],
...
use MIP::Program::Qc::Rseqc qw{ rseqc_junction_saturation };
use MIP::Test::Commands qw{ test_function };

diag(   q{Test rseqc_junction_saturation from Rseqc.pm v}
...
my $module_function_cref = \&rseqc_junction_saturation;
