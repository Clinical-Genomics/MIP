package MIP::Recipes::Download::Gens_gnomad_positions;
...
BEGIN {
    ...
    our @EXPORT_OK = qw{ download_gens_gnomad_positions };

}

sub download_gens_gnomad_positions {

## Function : Download positions of filtered gnomad-SNVs
## Returns  :
