...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Vcfanno_functions} =>
          [qw{ download_vcfanno_functions }],
...
diag(   q{Test download_vcfanno_functions from Vcfanno_functions.pm v}
      . $MIP::Recipes::Download::Vcfanno_functions::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{vcfanno_functions};
...
my $is_ok = download_vcfanno_functions(
    {
