...
## Modules with import
    my %perl_module = (
        q{MIP::Program::Genmod} => [qw{ genmod_compound }],
...
use MIP::Program::Genmod qw{ genmod_compound };

diag(   q{Test genmod_compound from Genmod.pm v}
...
my $module_function_cref = \&genmod_compound;
