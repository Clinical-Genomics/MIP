...
diag(   q{Test analysis_deepvariant from Deepvariant.pm v}
      . $MIP::Recipes::Analysis::Deepvariant::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
$file_info{io}{TEST}{$sample_id}{markduplicates}{out}{file_suffix} = q{.bam};
