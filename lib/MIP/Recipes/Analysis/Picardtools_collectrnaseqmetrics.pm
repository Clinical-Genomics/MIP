package MIP::Recipes::Analysis::Picardtools_collectrnaseqmetrics;
...
sub analysis_picardtools_collectrnaseqmetrics {

## Function : Calculates rna seq metrics on BAM files.
## Returns  :
