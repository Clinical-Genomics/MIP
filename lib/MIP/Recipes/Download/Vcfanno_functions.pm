package MIP::Recipes::Download::Vcfanno_functions;
...
BEGIN {
    ...
    our @EXPORT_OK = qw{ download_vcfanno_functions };

}

sub download_vcfanno_functions {

## Function : Download lua file with vcfanno functions
## Returns  :
