package MIP::Recipes::Download::Reduced_penetrance;
...
BEGIN {
    ...
    our @EXPORT_OK = qw{ download_reduced_penetrance };

}

sub download_reduced_penetrance {

## Function : Download reduced penetrance gene list
## Returns  :
