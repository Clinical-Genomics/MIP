...
The following lines are printed by looping over the nested hashes generated while testing the file in the test "check_parameter_hash.t" with the yaml definition file "[define_parameters.yaml]" (https://github.com/Clinical-Genomics/MIP/blob/develop/definitions/define_parameters.yaml) (date: 2018-01-23).
