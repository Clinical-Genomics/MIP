...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Mip_vcfparser} => [qw{ analysis_mip_vcfparser }],
...
diag(   q{Test analysis_mip_vcfparser from Mip_vcfparser.pm v}
...
$active_parameter{vcfparser_select_file} = catfile($Bin, qw{ data 643594-miptest aggregated_gene_panel_test.txt });
...
my $is_ok = analysis_mip_vcfparser(
    {
