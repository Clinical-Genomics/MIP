...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Reduced_penetrance} =>
          [qw{ download_reduced_penetrance }],
...
diag(   q{Test download_reduced_penetrance from Reduced_penetrance.pm v}
      . $MIP::Recipes::Download::Reduced_penetrance::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{reduced_penetrance};
my $reference_version = q{2017};
...
my $is_ok = download_reduced_penetrance(
    {
