...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Cadd_whole_genome_snvs} =>
...
diag(   q{Test download_cadd_whole_genome_snvs from Cadd_whole_genome_snvs.pm v}
      . $MIP::Recipes::Download::Cadd_whole_genome_snvs::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{cadd_whole_genome_snvs};
...
my $is_ok = download_cadd_whole_genome_snvs(
    {
