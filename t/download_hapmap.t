...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Hapmap} => [qw{ download_hapmap }],
...
diag(   q{Test download_hapmap from Hapmap.pm v}
      . $MIP::Recipes::Download::Hapmap::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{hapmap};
my $reference_version = q{3.3};
