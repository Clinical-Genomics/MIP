...
## Modules with import
    my %perl_module = (
        q{MIP::Program::Qc::Rseqc} => [qw{ rseqc_inner_distance}],
...
use MIP::Program::Qc::Rseqc qw{ rseqc_inner_distance};
use MIP::Test::Commands qw{ test_function };

diag(   q{Test rseqc_inner_distance from Rseqc.pm v}
...
my $module_function_cref = \&rseqc_inner_distance;
