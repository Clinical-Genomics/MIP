...
## Modules
    my @modules = (q{MIP::Program::Variantcalling::Delly});
...
my %required_argument = (
    filter_mode => {
        input           => q{somatic},
        expected_output => q{--type somatic},
    },
    infile_path => {
        input           => catfile(qw{ outfile_path prefix_DEL_concatsuffix}),
        expected_output => catfile(qw{ outfile_path prefix_DEL_concatsuffix}),
    },
    sv_type => {
        input           => q{DEL},
...
my $module_function_cref = \&delly_filter;
