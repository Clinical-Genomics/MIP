...
use MIP::Program::Alignment::Gatk qw{ gatk_indelrealigner };
use MIP::Test::Commands qw{ test_function };

diag(   q{Test gatk_indelrealigner from Alignment::Gatk.pm v}
...
my %required_argument = (
    known_alleles_ref => {
        ...
        expected_output =>
q{--knownAlleles GRCh37_1000g_indels_-phase1-.vcf --knownAlleles GRCh37_mills_and_1000g_indels_-gold_standard-.vcf },
    },
    intervals_ref => {
    ...
    target_intervals_file => {
        input           => catfile(qw{ dir target.interval }),
        expected_output => q{--targetIntervals }
          . catfile(qw{ dir target.interval }),
    },
);
...
q{--knownAlleles GRCh37_1000g_indels_-phase1-.vcf --knownAlleles GRCh37_mills_and_1000g_indels_-gold_standard-.vcf},
    ...
    consensus_determination_model => {
        input           => q{USE_READS},
        expected_output => q{--consensusDeterminationModel USE_READS},
    },
    target_intervals_file => {
        input           => catfile(qw{ dir target.interval }),
        expected_output => q{--targetIntervals }
...
my $module_function_cref = \&gatk_indelrealigner;
