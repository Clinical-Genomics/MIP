...
## When getting the merge_infile_prefix
...
## Then the merge infile prefix should be gotten from the file_info hash
is( $get_merged_infile_prefix, $merged_infile_prefix, q{Got merged infile prefix for sample id} );
