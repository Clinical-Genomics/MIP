...
### User Options
    GetOptions(
        ...
        q{sdtmod|sambamba_depth_mode:s} =>
          \$active_parameter{sambamba_depth_mode},
        q{sdtcut|sambamba_depth_cutoffs:s} =>
          \@{ $active_parameter{sambamba_depth_cutoffs} },
        q{sdtbed|sambamba_depth_bed:s} =>
          \$active_parameter{sambamba_depth_bed},
        ...
        q{pbgc|pbedtools_genomecov=n} =>
          \$active_parameter{pbedtools_genomecov},
        ...
        q{delexc|delly_exclude_file:s} =>
          \$active_parameter{delly_exclude_file},
        ...
        q{svravrm|sv_rank_model_file:s} =>
          \$active_parameter{sv_rank_model_file},
        ...
        q{pggt|pgatk_genotypegvcfs=n} =>
          \$active_parameter{pgatk_genotypegvcfs},
        ...
        q{pgvea|pgatk_variantevalall=n} =>
          \$active_parameter{pgatk_variantevalall},
        ...
        q{vepc|vep_directory_cache:s} =>
          \$active_parameter{vep_directory_cache},
