package MIP::Recipes::Download::Ctat_resource_lib;
...
## MIPs lib/
use MIP::Constants qw{ $ASTERISK $NEWLINE $SPACE $UNDERSCORE };
...
sub download_ctat_resource_lib {

## Function : Download ctat_resource_lib
## Returns  :
