...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Analysis::Star_caller} => [qw{ analysis_star_caller }],
...
diag(   q{Test analysis_star_caller from Star_caller.pm v}
      . $MIP::Recipes::Analysis::Star_caller::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
set_genome_build_constants(
    {
        genome_source  => q{grch},
        genome_version => $GENOME_VERSION_37,
    }
);

## Given analysis parameters
my $recipe_name    = q{star_caller};
