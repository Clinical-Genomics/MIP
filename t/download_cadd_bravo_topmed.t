...
## Modules with import
    my %perl_module = (
        q{MIP::Recipes::Download::Cadd_bravo_topmed} =>
          [qw{ download_cadd_bravo_topmed }],
...
diag(   q{Test download_cadd_bravo_topmed from Cadd_bravo_topmed.pm v}
      . $MIP::Recipes::Download::Cadd_bravo_topmed::VERSION
      . $COMMA
      . $SPACE . q{Perl}
      . $SPACE
      . $PERL_VERSION
...
my $recipe_name       = q{cadd_bravo_topmed};
...
my $is_ok = download_cadd_bravo_topmed(
    {
